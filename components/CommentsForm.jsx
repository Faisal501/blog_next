...
const CommentsForm = ({slug}) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div >
                    <input ref={storeDataEl} type="checkbox" name="storeData"/>
                    <label className="text-gray-500 cursor-pointer ml-3" htmlFor="storeData">Save my Name and Email for next time Comments</label> 
                </div>
            </div>
